...
from DuskyMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from DuskyMusic.utils.inline.playlist import close_markup
from DuskyMusic.utils.pastebin import Duskybin
from DuskyMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Dusky.force_stop_stream(chat_id)
